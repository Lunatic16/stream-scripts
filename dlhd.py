...
"""
dldh.py — browse DaddyLive 24/7 TV channels in your terminal
...
Usage:
    python dldh.py
    python dldh.py --raw           # disable ANSI colors
    python dldh.py --play          # output only the decrypted m3u8 URL
