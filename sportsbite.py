#!/usr/bin/env python3
"""
sportsbite.py — browse SportsBite 24/7 TV channels in your terminal
...
Usage:
    ...
    python sportsbite.py --raw           # disable ANSI colors
    python sportsbite.py --play          # output only the decrypted m3u8 URL
